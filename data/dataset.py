...
class YOLODataset(BaseDataset):
    ...
    def update_labels_info(self, label):
        """Custom label format processing."""
...
class ClassificationDataset:
    def __init__(self, root, args, augment=False, prefix=""):
        ...
        if self.cache_ram:
            LOGGER.warning("Classification cache_ram training has known memory leak, setting cache_ram=False.")
        ...
        self.torch_transforms = classify_augmentations(
            ...
            hsv_s=args.hsv_s,
            hsv_v=args.hsv_v
        ) if augment else classify_transforms(size=args.imgsz, crop_fraction=args.crop_fraction)
